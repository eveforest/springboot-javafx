...
public class DrawUtil {
    ...
    private final static double MIN_WIDTH = UIConstant.ROOT_STAGE_MIN_WIDTH;// 窗口最小宽度
    private final static double MIN_HEIGHT = UIConstant.ROOT_STAGE_MIN_HEIGHT;// 窗口最小高度
